  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <form method="post" action="./reports/sm_skulist_excel.php">
          <div id="formbrand" class="row" style="background-color: #F5FFFA; margin: 2px 2px 10px 2px; padding: 18px; border: 1px solid #A9A9A9;">
          <div class="col-sm-2">
